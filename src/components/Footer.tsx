...
export function Footer() {
    ...
    return (
        <footer className={'w-full h-[14rem] flex-center-col bg-black/25'}>
            <p className={'w-full flex-center py-1.5 text-[0.92rem] text-white/80 text-balance bg-black/10'}>Site trabalhado em Next/React com Typescript e Tailwind</p>
            <div className={'containerer flex-1 full flex justify-around items-center text-white/85 bg-gradient-to-b from-black/10 via-black/0'}>
                <div>
                    <p className={'text-xl font-semibold text-center'}>Contatos:</p>
                ...
                <div className={'pr-1'}>
                    <p className={'text-xl font-semibold text-center'}>Sites alternativos:</p>
